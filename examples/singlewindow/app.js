...
(function(exports) {
  ...
  var main = function __do() {
      ...
      return Electron_App.onReady(function __do() {
          ...
          var v2 = Electron_BrowserWindow.newBrowserWindow([ new Electron_BrowserWindow.Width(1200), new Electron_BrowserWindow.Height(600), new Electron_BrowserWindow.WebPreferences([ new Electron_BrowserWindow.OverlayScrollbars(true), new Electron_BrowserWindow.ZoomFactor(1.0) ]) ])();
          Electron_BrowserWindow.onClose(v2)(Electron_App.quit)();
          return Electron_BrowserWindow.loadURL(v2)("file://" + (Node_Globals.__dirname + "/window.html"))();
      })();
  };
  exports["main"] = main;
})(PS["App"] = PS["App"] || {});
