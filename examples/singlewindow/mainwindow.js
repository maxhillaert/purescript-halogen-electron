...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot(ButtonSlot.value)(Button.myButton)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleButton.create)), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Button has been toggled " + (Data_Show.show(Data_Show.showInt)(state.toggleCount) + " time(s)")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Last time I checked, the button was: " + (Data_Maybe.maybe("(not checked yet)")(function (v) {
              if (v) {
                  return "on";
              };
              return "off";
          })(state.buttonState) + ". ")), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CheckButtonState.create)) ])([ Halogen_HTML_Core.text("Check now") ]) ]) ]);
      };
      var initialState = {
          toggleCount: 0, 
      ...
      var $$eval = function (v) {
          if (v instanceof HandleButton) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $16.toggleCount = st.toggleCount + 1 | 0;
                  return $16;
              }))(function () {
          ...
          if (v instanceof CheckButtonState) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqButtonSlot)(ButtonSlot.value)(Halogen_Query.request(Button.IsOn.create)))(function (v1) {
          ...
          throw new Error("Failed pattern match at MainWindow line 59, column 10 - line 66, column 16: " + [ v.constructor.name ]);
      };
